...
export const WhyChooseUs = () => {
  ...
  return (
    <section className="py-20 bg-bg-warm relative overflow-hidden border-t border-border-primary">
      {/* Neo-Minimal background element */}
      <div className="absolute -right-[10%] top-[20%] w-[40%] h-[60%] rounded-full bg-primary/5 blur-[100px] z-0 pointer-events-none" />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-[35%] flex justify-center">
            <motion.div
              ...
              className="relative w-full max-w-[280px] rounded-2xl overflow-hidden soft-shadow border border-border-primary bg-white p-6 flex flex-col items-center justify-center gap-4 text-left"
            >
              {/* Glow Behind Logo */}
              <div className="absolute w-36 h-36 bg-primary/10 blur-3xl z-0 rounded-full pointer-events-none" />
              ...
              <div className="bg-bg-secondary border border-border-primary p-3 rounded-xl w-full text-center relative z-10 shadow-sm">
                <div className="text-2xl font-space-grotesk font-bold text-text-heading mb-0.5">1+</div>
                <div className="text-text-body text-xs font-semibold font-inter">Years of combined engineering experience</div>
              </div>
            </motion.div>
          </div>

          {/* Right: Section Info & Clean Symmetrical List */}
          <div className="w-full lg:w-[65%] text-left flex flex-col items-start">
            <SectionTitle 
              tag="Why Altima"
              title="Why Choose Altima?" 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              {reasons.map((reason, index) => (
                ...
                >
                  ...
                  <span className="text-text-heading text-sm font-semibold font-space-grotesk">{reason}</span>
                </motion.div>
              ))}
            </div>
